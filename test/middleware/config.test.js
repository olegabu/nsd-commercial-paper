...
describe('config converter', function(){
  ...
  result2["organizationa"].role = 'nsd';
  result2["organizationb"].role = 'nsd';
  // result2.role = 'nsd';
